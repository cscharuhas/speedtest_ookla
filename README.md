...
5. It then goes on to create a scheduled task in the windows task scheduler by the name "prahar_ookla" in the "MyTasks" folder. This task is configured to run the C:\Users\\%username%\Desktop\speed.bat for the specified time interval.
...
# NOTE
It is important to note that the scheduled task searches for the script to execute in the location "C:\Users\\%username%\Desktop\speed.bat". So, it is abslutely necessary that the speed.bat file be present at the location for the automated task to work.
